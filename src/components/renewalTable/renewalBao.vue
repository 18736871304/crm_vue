<template>
  <div class="table-box">
    <el-table :data="dataRen" ref="multipleTable" border v-loading="loading" style="width: 100%" @selection-change="handleSelectionChange" @sort-change="sortChange" class="splice-header">
      ...
      <el-table-column key="7" align="center" prop="originalDate" label="保单截至日" width="160" sortable> </el-table-column>
      <el-table-column key="8" align="center" prop="xbpaytime" label="续保成功日" width="160"> </el-table-column>
