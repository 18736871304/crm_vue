    ...
    <div class="container-table">
      ...
      <div class="check-all-box" v-if="isArticle">
        ...
        <div class="container-middle-two" style="float: right;">
          ...
          <el-popover popper-class="entry-customer-popper" v-show="false" placement="bottom-start" width="3.31rem" trigger="click" v-model="deleteSourceVisable">
      ...
      <div class="check-all-table">
        <el-table v-if="isArticle" :data="tableData" ref="multipleTable" border v-loading="loading" style="width: 100%" @selection-change="handleSelectionChange" @sort-change="sortChange">
          ...
          <!-- <el-table-column key="13"   prop="cusdealtime" align="center" label="客户成交时间" width="155" :show-overflow-tooltip="true">
          </el-table-column>
          <el-table-column key="14"   prop="cusdealperiod" align="center" label="客户成交周期" width="100" :show-overflow-tooltip="true">
          </el-table-column> -->
          <el-table-column key="18" v-if="false" prop="pageurl" label="推广页面" width="150" :show-overflow-tooltip="true" align="center">
            <template slot-scope="scope">
              <a style="cursor: pointer;" href="#" @click="disPageUrl(scope.row)">{{ scope.row.pageurl }}</a>
            </template>
          </el-table-column>
          <el-table-column key="19" prop="previstitime" label="预约回访" min-width='200' width="auto" :show-overflow-tooltip="true" align="center" sortable="custom" class-name="yuyue">
            <template slot-scope="scope">
          ...
          <el-table-column key="16" prop="clue_sourcename" align="center" label="线索来源" width="90" :show-overflow-tooltip="true">
          </el-table-column>
          <el-table-column key="17" prop="appname" align="center" label="流量来源" width="100" :show-overflow-tooltip="true">
          </el-table-column>
          <!-- fixed="right" -->
        </el-table>
