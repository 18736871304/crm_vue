  ...
  <div class="customerManagementNew Container">
    <div class="container-top">
      ...
      <div class="container-top-two" style="overflow-x: auto; overflow-y: hidden">
        <div class="container-search-box">
          ...
          <div class="common-select">
            <div class="select-title filtitle">客户昵称</div>
            <div class="select-content filContent">
    ...
    <div class="container-table">
      ...
      <div class="check-all-box" v-if="isArticle">
        ...
        <div class="container-middle-two" style="float: right;display: none;">
      ...
      <div class="check-all-table">
        <el-table v-if="isArticle" :data="tableData" ref="multipleTable" border v-loading="loading" style="width: 100%" @selection-change="handleSelectionChange" @sort-change="sortChange">
          ...
          <el-table-column key="3" label="客户昵称" width="100" fixed="left" align="center" :show-overflow-tooltip="true">
          ...
          <el-table-column key="6" align="center" label="跟进步骤" width="110" :show-overflow-tooltip="true">
            ...
            <template slot-scope="scope">
              ...
              <span class="followTag" v-else-if="scope.row.followupstepname == '已成交'">已成交</span>
          ...
          <el-table-column key="12" v-if="dis_P4_up" prop="callcount" align="center"  sortable   :sort-method="customSort" label="累计拨打次数" width="130" :show-overflow-tooltip="true"> </el-table-column>
    ...
    <el-drawer title="我是标题" :size="drawerSize" custom-class="customer-drawer" :visible.sync="drawer" :with-header="false">
  ...
  mounted: function () {
    ...
    this.$nextTick(() => {
      ...
      let params = {
        ...
        mobile: "",
        wxno: "",
        followupstep: "01,02,03,04,05,06,07,99",
 ...
 customSort(a, b) {
    ...
    search(page) {
      ...
      let params = {
        ...
        mobile: this.mobile,
        wxno: this.wxno,
        followupstep: this.activeName == '' ? "01,02,03,04,05,06,07,99" : this.activeName,
      ...
      if (params.followupstep == "") {
        params.followupstep = "01,02,03,04,05,06,07,99";
      }
