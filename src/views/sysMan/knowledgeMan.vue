  ...
  <div class="customerManagement" id="container" v-cloak style=" width: 17.1rem;">
      ...
      <div class="search-box clearfix">
        ...
        <div class="common-select">
          ...
          <div class="select-content" style="width: calc(100% - 1.28rem);">
            <el-autocomplete class="el-input-inners" v-model="keyword" :trigger-on-focus="false" :fetch-suggestions="querySearch" size="mini" placeholder="请输入关键字"></el-autocomplete>
          </div>
        </div>
    ...
    <div class="table-box">
      <el-table :data="tableData" border style="width: 100%" :header-cell-class-name="headerClassName">
        ...
        <el-table-column key="8" align="center" prop="publishtime" label="发布时间" width="155" :show-overflow-tooltip="true">
        </el-table-column>
        <el-table-column key="2" align="center" prop="title" label="文章标题" width="180" :show-overflow-tooltip="true">
        </el-table-column>
        <el-table-column key="5" align="center" prop="channelname" label="渠道类型" width="180" :show-overflow-tooltip="true">
        </el-table-column>
        <el-table-column key="3" align="center" prop="seotitle" label="SEO标题" width="155" :show-overflow-tooltip="true">
        </el-table-column>
        <el-table-column key="4" align="center" prop="seokeywords" label="SEO关键词" width="100" :show-overflow-tooltip="true">
        </el-table-column>

        <el-table-column key="6" align="left" prop="seodescription" label="SEO描述" :show-overflow-tooltip="true">
        </el-table-column>
        <el-table-column key="7" align="left" prop="source_url" label="封面图" :show-overflow-tooltip="true">
        </el-table-column>

        <!-- <el-table-column key="9" align="center" prop="askedflowdesc" label="跟进步骤" width="180" :show-overflow-tooltip="true">
        </el-table-column> -->

        <el-table-column key="10" align="center" label="操作" width="200">
...
export default {
  ...
  methods: {
    ...
    getmain() {
      ...
      console.log(params)
      getPhoneData('get', 'https://www.dajiala.com/fbmain/monitor/v3/article_html', function (data) { //渠道类型
        console.log(data)
        var data = data.data
        _this.articleItem.head_pic_url = data.cover_url
        _this.articleItem.publish_time = data.post_time_str
        _this.articleItem.info = data.signature
    ...
    updateCJGitem(isUpload) {
      ...
      let url, data
      // console.log(this.articleItem.id != '')
      ...
      return new Promise((resovle, reject) => {
        getData('post', my_url + url, res => {
          if (res.code == 0) {
            ...
            //   this.articleItem.askedtype = ''
            //   this.articleItem.askedflow = ''
            //   this.insorganName1 = ''

            // }

            // if (res.baseid) {
            //   this.articleItem.baseid = res.baseid
            //   resovle(res)
            // } else {
            //   // this.bdjsItem.baseid && resovle(this.bdjsItem)
            //   // this.jbhbItem.baseid && resovle(this.jbhbItem)
            //   this.articleItem.baseid && resovle(this.articleItem)
            // }
          } else {
            this.$message({
              showClose: true,
    ...
    showEditPopup(item) {
      ...
      this.articleItem.head_pic_url = 'https://mmbiz.qpic.cn/sz_mmbiz_jpg/xrFYciaHL08ABmrcAB7qN5uMLZN9uVfXViauP8uYZNmHL3xE95W4n6o6Vp6vpCMjcunBgibl3LsKDoU4bEg8svY9Q/0?wx_fmt=jpeg'
      this.articleItem.publish_time = '2024-07-31 13:42'
      this.articleItem.info = '参与、沟通、记录时代。'
