        ...
        <div class="select-content" style="margin-bottom: 0.1rem;">
          <el-dropdown trigger="click" style="width: 100%" placement="bottom" ref="disTeam">
            ...
            <el-dropdown-menu class="" slot="dropdown">
              <el-tree @check="checkTeam" :data="teamDataList" ref="tree" show-checkbox node-key="id" :default-checked-keys="[1]" :props="defaultProps">
              </el-tree>
          ...
          <el-tabs v-model="activeName" @tab-click="handleClick" style="width: 100%">
            ...
            <div v-loading="paneloading">
              <template v-if="firstAllName != ''">
                <div class="staffList staffListBottom" ref="first" style="margin-top: 0;     height: calc(100vh - 4.2rem);">
              ...
              <template v-if="firstAllName == ''">
                <div class="staffList" ref="first" style="margin-top: 0;  height: calc(100vh - 4.2rem);">
      ...
      <div class="chatHistory" v-loading="loading">
        ...
        <div class="staffList" ref="list" style="margin-top: 0;  height: calc(100vh - 2.7rem);">
          <template v-if="requestDataList.length > 0 && searchText">
            <div class='staffName' style="margin-top: 0.2rem;" v-for="item of requestDataList" :key="item.seq" :label="item.username" :value="item.userid">
              <div>
                <!-- 聊天记录 开始 -->
