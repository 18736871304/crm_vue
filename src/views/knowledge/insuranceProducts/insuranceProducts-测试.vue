          ...
          <el-tabs v-model="item.mainName" @tab-click="mainClick">
            ...
            <el-tab-pane label="图片" name="tupian">
              <div class="listMainbox">
                ...
                <div class="imgupload">
                  <el-upload accept="image/*" action="#" ref="imgupload" list-type="picture-card" :auto-upload="false" :limit="1" :file-list="item.img.uploadFilePath" :on-change="
                      (file) => {
                ...
                <div style="margin-bottom: 0.15rem">
                  <div class="videoupload">
                    <el-upload accept="video/*" action="#" ref="videoupload" list-type="picture-card" :auto-upload="false" :file-list="item.video.uploadFilePath" :limit="1" :on-change="
                      ...
                      <div slot="file" slot-scope="{ file }">
                        <img class="el-upload-list__item-thumbnail" :src="item.video.file.refilepath" alt="" />
                        <span class="el-upload-list__item-actions">
      ...
      $.ajax({
        ...
        .done(function (res) {
          if (res.code == 0) {
            ...
            console.log(_this.dataList[index][fileType].uploadFilePath, 222)
