  ...
  <div>
      ...
      <div class="search-box clearfix">
        <div class="common-select">
          ...
          <div
            ...
            style="height: 0.3rem; width: calc(100% - 1.28rem); border: none"
          >
            <el-date-picker
              v-model="selectTime"
              type="daterange"
        ...
        <div class="common-select">
          ...
          <div
            class="select-content"
            style="width: calc(100% - 1.28rem); border: none"
          >
            <el-select
      ...
      >
        ...
        >
          <template slot-scope="scope">
            ...
            <a
              v-else
              style="color: #8f9198; cursor: pointer"
              @click="noDownLoad(scope.row)"
              target="_blank"
              :href="scope.row.policyurl"
              >下载</a
            >
        ...
        <el-table-column align="center" label="操作" width="140">
          <template slot-scope="scope">
            <a
              href="javascript:void(0);"
              style="color: #4985e5"
              v-if="scope.row.state == '82' || scope.row.state == '80'"
              @click="EditPopup(scope.row)"
              >编辑</a
            >
            <a
              href="javascript:void(0);"
              style="color: #dc220d; margin-left: 0.15rem"
              v-if="scope.row.state == '82' || scope.row.state == '80'"
      ...
      <div class="" style="position: relative">
        ...
        <div class="search-box clearfix">
          <div class="common-select">
            ...
            <div
              class="select-content"
              style="height: 0.3rem; width: calc(100% - 1.38rem); border: none"
            >
              <el-date-picker
                class="el-date-picker-sigle"
                v-model="inSelectTime"
                value-format="yyyy-MM-dd"
                @change="changeDate"
                type="date"
                align="right"
        ...
        <div class="search-box clearfix">
          ...
          <div class="common-select" style="width: 50%">
            ...
            <div
              class="select-content"
              style="width: calc(100% - 1.3rem); height: 0.3rem; border: none"
            >
              <el-select
                class="el-select-inners"
                v-model="inmainriskcode"
                size="mini"
                placeholder=""
                :disabled="disabled"
        ...
        <div class="search-box clearfix">
          <div class="common-select">
            ...
            <div
              class="select-content"
              style="width: calc(100% - 1.38rem); height: 0.3rem; border: none"
              v-if="Amntselect"
            >
              <el-select
                class="el-select-inners"
              ...
              >
                <el-option
                  v-for="(item, index) in insuranceAmountList"
                  :key="index"
                  :label="item.dd_value"
                  :value="item.dd_key"
                >
          ...
          <div class="common-select">
            ...
            >
              ...
              >
                <el-option
                  v-for="(item, index) in paymentPeriodList"
                  :key="index"
                  :label="item.dd_value"
                  :value="item.dd_key"
                >
          ...
          <div class="common-select">
            ...
            >
              <el-select
                class="el-select-inners"
                v-model="guaranteePeriod"
                size="mini"
                placeholder=""
                :disabled="disabled"
              >
                <el-option
                  v-for="(item, index) in guaranteePeriodList"
                  :key="index"
                  :label="item.dd_value"
                  :value="item.dd_key"
                >
        ...
        <div class="search-box clearfix">
          ...
          <div class="common-select">
            ...
            >
              ...
              >
                <el-option
                  v-for="(item, index) in appcityList"
                  :key="index"
                  :label="item.dd_value"
                  :value="item.dd_key"
                >
          ...
          <div class="common-select">
            ...
            >
              ...
              >
                <el-option
                  v-for="(item, index) in appRegionList"
                  :key="index"
                  :label="item.dd_value"
                  :value="item.dd_key"
                >
          ...
          <div class="search-box clearfix">
            <div class="common-select">
              ...
              >
                <el-select
                  ...
                  v-model="inpeople"
                  size="mini"
                  @change="inpeopleSelect"
                  placeholder=""
                  :disabled="disabled"
                >
                  <el-option
                    v-for="(item, index) in ispeoplelist"
                    :key="index"
                    :label="item.dd_value"
                    :value="item.dd_value"
                  >
            ...
            <div class="common-select" v-if="ispeople">
              ...
              >
                ...
                >
                  <el-option
                    v-for="(item, index) in relatoappList"
                    :key="index"
                    :label="item.dd_value"
                    :value="item.dd_key"
                  >
          ...
          <div class="search-box clearfix" v-if="inoType">
            ...
            <div class="common-select">
              ...
              >
                ...
                >
                  <el-option
                    v-for="(item, index) in editSexList"
                    :key="index"
                    :label="item.dd_value"
                    :value="item.dd_key"
                  >
          ...
          <div class="search-box clearfix" v-if="ispeople">
            <div class="common-select">
              ...
              <div class="select-content" style="width: calc(100% - 1.38rem)">
                <el-autocomplete
                  class="el-input-inners"
                  v-model="insuredProvince"
                  :trigger-on-focus="false"
                  :fetch-suggestions="countryquerySearch"
                  size="mini"
                  placeholder=""
                  @select="inprovinceSelect"
                  :disabled="disabled"
                  clearable
                >
                </el-autocomplete>
            ...
            <div class="common-select">
              ...
              >
                ...
                >
                  <el-option
                    v-for="(item, index) in incityList"
                    :key="index"
                    :label="item.dd_value"
                    :value="item.dd_key"
                  >
            ...
            <div class="common-select">
              ...
              >
                ...
                >
                  <el-option
                    v-for="(item, index) in inRegionList"
                    :key="index"
                    :label="item.dd_value"
                    :value="item.dd_key"
                  >
    ...
    >
      <div class="download-list" v-for="(item, index) in gridData" :key="index">
        <p>
          {{ index + 1 }}.<a :href="item.policyurl" target="_blank"
            >&nbsp; 下载</a
          >
        </p>
      </div>
    ...
    <view-details
      :datas="detailObj"
      :showEditPopupDialogVisible.sync="showEditPopupDialogVisible"
      @updateVisible="updateVisibleId"
    ></view-details>
  </div>
</template>
<script>
