...
import { formatDate, getBirthdayByIDCard, getSexByIDCard, getIdCardAge } from "../../../static/js/common.js";
export default {
  data() {
    return {
      // 列表选择项
  ...
  methods: {
          ...
          getData(
            ...
            (data) => {
              ...
              if (data.rows.length > 1) {
                ...
                _this.getRiskcode(data.rows[0].riskcode);
    ...
    citySelect() {
      getData(
        "post",
        my_url + "/crm/common/getCountry.do",
        (data) => {
          if (data.code == 0) {
    ...
    inmainriskSelect(item) {
      ...
      getData("post", my_url + "/crm/auth/getToken.do", (data) => {
        if (data.code == 0) {
          ...
          getData(
            "post",
            crm_url + "insure.meihualife.com/crm_web/getRiskAmntType.do",
            (data) => {
              var _this = this;
              if (data.amnttype == "01") {
                ...
                getData(
                  "post",
                  crm_url + "insure.meihualife.com/crm_web/getAmntList.do",
                  (data) => {
                    if (data.code == 0) {
          ...
          getData(
            "post",
            crm_url + "insure.meihualife.com/crm_web/getPayintvList.do",
            (data) => {
              if (data.code == 0) {
          ...
          getData(
            "post",
            crm_url + "insure.meihualife.com/crm_web/getPayendyearList.do",
            (data) => {
              if (data.code == 0) {
          ...
          getData(
            "post",
            crm_url + "insure.meihualife.com/crm_web/getInsureyearList.do",
            (data) => {
              if (data.code == 0) {
          ...
          getData(
            "post",
            crm_url + "insure.meihualife.com/crm_web/riskCheck.do",
            (data) => {
              if (data.code == 0) {
              } else {
                this.$message({
    ...
    search(page) {
      ...
      getData("post", my_url + "/crm/auth/getToken.do", (data) => {
        if (data.code == 0) {
          ...
          getData(
            "post",
            crm_url + "insure.meihualife.com/crm_web/getPolicySum.do",
            (data) => {
              if (data.code == "0") {
                _this.policycount = data.sumData.policycount != undefined ? data.sumData.policycount : "0";
    ...
    channelSelect() {
      ...
      return new Promise((resolve, reject) => {
        getData(
          ...
          {
            dict_type: "sourcedetail_" + _this.channelValue,
            special: "dis",
          }
        );
      });
    ...
    aapChangePhone() {
      ...
      getData("post", my_url + "/crm/auth/getToken.do", (data) => {
        ...
        getData(
          "post",
          crm_url + "insure.meihualife.com/crm_web/getCusInfoByMobile.do",
          (data) => {
            if (data.code == 0) {
              if (data.cusinfo.length != 0) {
                ...
                (_this.applicantCity = data.cusinfo[0].city), _this.citySelect();
                (_this.applicantRegion = data.cusinfo[0].country), (_this.applicantAddress = data.cusinfo[0].address);
              }
            }
          },
          body
    ...
    appChangeIDCard() {
      ...
      getData("post", my_url + "/crm/auth/getToken.do", (data) => {
        ...
        getData(
          "post",
          crm_url + "insure.meihualife.com/crm_web/getCusInfoByIdno.do",
          (data) => {
            if (data.code == 0) {
              if (data.code == 0) {
                if (data.cusinfo.length != 0) {
          ...
          (data) => {
            if (data.code == 0) {
              if (data.cusinfo.length != 0) {
                ...
                _this.inprovinceSelect(item);
                (_this.insuredCity = data.cusinfo[0].city), _this.incitySelect();
                (_this.insuredRegion = data.cusinfo[0].country), (_this.insuredAddress = data.cusinfo[0].address);
              }
            }
          },
          body
          ...
          getData("post", my_url + "/crm/auth/getToken.do", (data) => {
            if (data.code == 0) {
              var data = {
                ...
                shanxi_licai_type: this.resourceTypeValue,
              };
              if (_this.risktype == "05") {
                data.shanxi_licai_type = this.resourceTypeValue;
              } else {
              ...
              getData(
                "post",
                crm_url + "insure.meihualife.com/crm_web/lifePolicyInsert.do",
                (data) => {
                  if (data.code == 0) {
        ...
        if (this.editPopupVisible == true) {
          ...
          getData("post", my_url + "/crm/auth/getToken.do", (data) => {
            if (data.code == 0) {
              ...
              if (_this.risktype == "05") {
                body.shanxi_licai_type = this.resourceTypeValue;
              } else {
    ...
    gridDataList(orderid) {
      ...
      getData("post", my_url + "/crm/auth/getToken.do", (data) => {
        ...
        getData(
          "post",
          crm_url + "insure.meihualife.com/crm_web/getPolicyUrlList.do",
          function (data) {
