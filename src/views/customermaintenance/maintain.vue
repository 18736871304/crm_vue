<template>
  <div style=" width: 17.1rem;">
    ...
    <div class="table-box">
      <el-table v-if="CJGselectValue == '服务客户' || CJGselectValue == '生日保单'" :data="tableData" border v-loading="loading" style="width: 100%" @selection-change="handleSelectionChange" @sort-change="sortChange" class="splice-header">
      ...
      <el-table v-if="CJGselectValue == '失效保单' || CJGselectValue == '终止保单'" :data="tableData" ref="multipleTable" border v-loading="loading" style="width: 100%;" @selection-change="handleSelectionChange" @sort-change="sortChange" class="splice-header">
        ...
        <el-table-column key="20" align="center" prop="insorganname" label="保险公司" width="130" :show-overflow-tooltip="true">
        </el-table-column>
        ...
        <el-table-column key="23" align="center" prop="appprovincename" label="投保人所在省" width="120" :show-overflow-tooltip="true">
        </el-table-column>
        <el-table-column key="24" align="center" prop="appcityname" label="投保人所在市" width="120" :show-overflow-tooltip="true">
        </el-table-column>
        <el-table-column key="25" align="center" prop="insname" label="被保人姓名" width="100" :show-overflow-tooltip="true">
        </el-table-column>
        <el-table-column key="26" align="center" prop="payintvvalue" label="缴费方式" width="80" :show-overflow-tooltip="true">
        </el-table-column>
        <el-table-column key="27" align="center" prop="payendyearvalue" label="缴费年期" width="80" :show-overflow-tooltip="true">
        </el-table-column>
        <el-table-column key="28" align="center" prop="insuyearvalue" label="保障期限" width="80" :show-overflow-tooltip="true">
        </el-table-column>
        <el-table-column key="29" align="center" prop="prem" label="保费" width="80" :show-overflow-tooltip="true">
        </el-table-column>
        <el-table-column key="30" align="center" prop="activitychannelname" label="渠道类型" width="80" :show-overflow-tooltip="true">
        </el-table-column>
          ...
          <div class="editBox">
            ...
            <div class="editContent">
              ...
              <div class="editContent_c editContent_box editContent_date" style=" font-size: 0.13rem;">
                ...
                <span class="dd">
                  <el-date-picker v-model="ceBirthday" type="date" size="mini" placeholder="请输入出生年月" class="difPicker" clearable style="width: 100%;" value-format="yyyy-MM-dd">
                  </el-date-picker>
                </span>
              </div>
